...
namespace PaymentAPI.Controllers
{
    ...
    public class PaymentDetailController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutPaymentDetail(int id, PaymentDetail paymentDetail)
        {
            ...
            //return NoContent();
            //Refresh list after updating the list
        ...
        public async Task<ActionResult<PaymentDetail>> PostPaymentDetail(PaymentDetail paymentDetail)
        {
          if (_context.PaymentDetails == null)
          {
            ...
            //Comment the exisiting below line of code as we need to refresh the list once the stored successfully or create a seperate get method to reload list
